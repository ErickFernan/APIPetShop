...
class ServiceFilter(django_filters.FilterSet):
    ...
    ciclo_id = django_filters.CharFilter(field_name='ciclo_id', lookup_expr='exact')
...
class ExamFilter(django_filters.FilterSet):
    ...
    pet_name = django_filters.CharFilter(field_name='service_id__ciclo_id__pet_id__name', lookup_expr='icontains')
    ...
    pet_id = django_filters.CharFilter(field_name='service_id__ciclo_id__pet_id', lookup_expr='exact')
